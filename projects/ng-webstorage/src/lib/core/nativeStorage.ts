...
export const LOCAL_STORAGE: InjectionToken<WebStorage> = new InjectionToken<WebStorage>(
...
export const SESSION_STORAGE: InjectionToken<WebStorage> = new InjectionToken<WebStorage>(
